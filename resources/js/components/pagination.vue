<template>
    ...
    <ul class="justify-content-center pagination">
        ...
        <template v-else-if=" paginator.current_page > 1">
            <li class="page-item">
                <a class="page-link link-first" aria-label="First" @click="$root.$emit('search',{'page':1})">
            ...
            <li class="page-item">
                <a class="page-link" aria-label="Previous"
                   @click="$root.$emit('search',{'page':paginator.current_page-1})">
        ...
        <li v-for="i in this.range(this.from,this.to)" class="page-item "
            ...
            <a class="page-link" @click="$root.$emit('search',{'page':i})">
                {{ i }}
            </a>
        </li>
        ...
        <template v-if="paginator.current_page < paginator.last_page">
            <li class="page-item">
                <a class="page-link" aria-label="Next" @click="$root.$emit('search',{'page':paginator.current_page+1})">
            ...
            <li class="page-item">
                <a class="page-link link-last" aria-label="Last"
                   @click="$root.$emit('search',{'page':paginator.last_page})">
